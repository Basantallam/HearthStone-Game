...
public class Game implements ActionValidator, HeroListener {
	...
	@Override
	public void onHeroDeath(Hero h) {
		Hero w = h==currentHero ? opponent : currentHero;
		listener.onGameOver(h , w);
	}
	...
	public void endTurn() throws FullHandException, CloneNotSupportedException {
		...
		opponent = temp;
		listener.onSwitch(currentHero, opponent);
	...
	public void onDeckUpdated( Hero hero) {
		listener.onDeckUpdated(hero);

	}

	public void onHandUpdated(Hero hero) {
		listener.onHandUpdated( hero);
	}
