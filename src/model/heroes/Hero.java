...
public abstract class Hero implements MinionListener {
	...
	public Hero(String name,String i) throws IOException, CloneNotSupportedException {
		this.name = name;
		currentHP = 30;
		this.n=i;
	...
	private void castSpellCommons(Spell s) {
		setCurrentManaCrystals(getCurrentManaCrystals()- s.getManaCost());
		hand.remove(s);
	}
	...
	public void onFieldUpdated() {
		listener.onFieldUpdated(this);
	}

	public void onDeckUpdated() {
		listener.onDeckUpdated(this);
	}
}
